...
static void cheat_main_vehicle ( double time_diff )
{
	...
	H_VehicleFlooder(info, time_diff);
	TH_VehicleTrollCar(info, time_diff);
...
void cheat_hook ( HWND wnd )
{
	...
	if ( cheat_state == nullptr )
	{
		...
		//---- Aþaðýya yazdýðýn hileler/fonksiyonlar oyuna giriþ yapýnca otomatik aktif hale gelecektir. ----//
		cheat_state->Korumalar.iAntiBulletCrasher = true;
		cheat_state->Korumalar.iAntiCarTroll = true;
		cheat_state->Korumalar.iAntiInvalidBulletsCrasher = true;
		cheat_state->Korumalar.iAntiPassengerCrasher = true;
		cheat_state->Korumalar.iAntiLoadingCrasher = true;
		cheat_state->Korumalar.iAntiRollCrasher = true;
		cheat_state->Korumalar.iAntiWarningCrasher = true;
		set.seeWeaponTags = true;
		cheat_state->Korumalar.iAntiShakingCamera = true;
		cheat_state->Korumalar.iAntiInvalidAimZ = true;
		...
		cheat_state->Korumalar.iAntiDiscoMode = true;
#endif
		cheat_state->Korumalar.iAntiDirectionCrasher = true;
		cheat_state->AntiTrailer.iAntifPositionCrasher = true;
		cheat_state->AntiTrailer.iAntifSpeedCrasher = true;
		cheat_state->AntiTrailer.iAntifSpinCrasher = true;
		//cheat_state->Silah.iSAim_VisibleFilter = true;

		//cheat_state->Korumalar.iNoCollisionActors = true;
		//cheat_state->Korumalar.iNoCollisionVehicles = true;
		
		//cheat_state->Graphics.fCutoffRange = 1000.0f;
		//cheat_state->Graphics.fSharpnessPower = 15.0f;
		//cheat_state->Graphics.fMatShininess = 1.0f;
		//cheat_state->Graphics.fLightShininess = 1.0f;
		//cheat_state->Graphics.fMatEmesColor = 1.0f;
		//cheat_state->Graphics.fMatAmbColor = 1.0f;
		//cheat_state->Graphics.fLightAmbColor = 1.0f;
		//cheat_state->Graphics.fMatDiffColor = 1.0f;
		//cheat_state->Graphics.fLightDiffColor = 1.0f;
