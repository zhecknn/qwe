...
public:
	...
	HRESULT		Print2(float x, float y, DWORD color, const char *szText, bool isShadow);
...
public:
	...
	void	DrawCircleFilled(float x, float y, float rad, int resolution, DWORD color); // From Stickey...
	...
	void	D3D_Double_Label_Menu(int x, int y, int w, int h, D3DCOLOR color, D3DCOLOR color2);
	...
	void	D3D_OL_Circle(float x, float y, float d, float fStart, float fEnd, D3DCOLOR color);
