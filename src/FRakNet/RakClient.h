...
public:
	...
	void RegisterAsRemoteProcedureCall(int* uniqueID, void(*functionPointer) (RPCParameters *rpcParms, void * param), void * param = 0);
	void RegisterAsRemoteProcedureCall(RPCEnumeration uniqueID, void(*functionPointer) (RPCParameters *rpcParms, void * param), void * param = 0);
	...
	void UnregisterAsRemoteProcedureCall(RPCEnumeration uniqueID);
	...
	bool RPC(int* uniqueID, const char *data, unsigned int bitLength, PacketPriority priority, PacketReliability reliability, char orderingChannel, bool shiftTimestamp);//, NetworkID networkID, BitStream *replyFromTarget );
	bool RPC(int* uniqueID, RakNet::BitStream *bitStream, PacketPriority priority, PacketReliability reliability, char orderingChannel, bool shiftTimestamp);//, NetworkID networkID, BitStream *replyFromTarget );
	bool RPC(RPCEnumeration uniqueID, RakNet::BitStream *bitStream, PacketPriority priority = HIGH_PRIORITY, PacketReliability reliability = UNRELIABLE_SEQUENCED, char orderingChannel = 0, bool shiftTimestamp = false);
